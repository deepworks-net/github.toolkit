...
def mock_git_repo():
    """
    Setup a temporary git repo structure for testing.
    This doesn't create actual files but mocks the necessary functions.
    """
...
@pytest.fixture
def git_outputs():
    """Provide sample git command outputs for testing."""
    return {
        'tags': "v1.0.0\nv1.1.0\nv2.0.0",
        'branches': "main\ndevelop\nfeature/test",
        'status': " M modified_file.txt\n?? untracked_file.txt",
        'log': "commit abc123\nAuthor: Test User\nDate: 2023-01-01\n\n    Test commit message"
    }